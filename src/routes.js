...
const routes = [
  ...
  { path: '/add-sub-categories', exact: true, name: 'Sub Category', component: AddSubCategory },
  { path: '/banners', exact: true, name: 'Banner', component: Banners },
  { path: '/add-banners', name: 'Add Banner', component: AddBanners },
  { path: '/permision', exact: true, name: 'Permision', component: Permision },
